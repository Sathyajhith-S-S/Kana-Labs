                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <Button onClick={toggleTheme} variant="secondary" size="sm" className="p-2 h-auto">
                            {theme === 'light' ? (
                                <svg className="hover:scale-75" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
